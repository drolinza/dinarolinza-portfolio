...
export const LoadingScreen = ({onComplete}) => {
    ...
    const fullText = "<Hi! This is Dina's Portfolio, come to take a look! />";
    ...
    return(
        <div className="fixed inset-0 z-50 bg-white text-black-500 flex flex-col items-center justify-center">
